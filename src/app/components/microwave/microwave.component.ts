...
export class MicrowaveComponent implements OnInit {
  ...
  displayedColumns2: string[] = ['id', 'action', 'managerName', 'companyName', 'contactName'
    , 'email', "mobile", 'numberOfCircuits', 'fullAddress', 'exchangeName', 'nearestFixedLineNumber', 'expectedUpgrades', 'notes', 'contractPeriod', 'serviceSpeed'
  ...
  constructor(private dialog: MatDialog,
    ...
    this.titleService.setTitle('Presales microwave Request');
  ...
  onEdit(r: any) {
    ...
    this.router.navigate(['/microwaveRequestForm'], { queryParams: { id: r.id } });
