...
delconct:any;
  ...
  constructor(private titleService:Title,private contactser:TeamcontactService
    ,private notser:ToastrService,private router: Router,
    private route: ActivatedRoute,private dialogService:DeleteService,private Config:ConfigureService
    ) {
    // Create 100 users
...
// }
  ...
  onDelete($key:any){
    ...
    .afterClosed().subscribe(res =>{
      if(res){
        this.contactser.delcontact($key).subscribe(
          res=>{
