...
export class CopperComponent implements OnInit {
  ...
  displayedColumns2: string[] = ['id', 'action', 'managerName', 'companyName', 'contactName'
    , 'email', "mobile", 'numberOfCircuits', 'fullAddress', 'exchangeName', 'nearestFixedLineNumber', 'expectedUpgrades', 'notes',  'serviceSpeed'
    ,'status', 'creationDate', 'modificationDate', 'createdBy', 'modifyiedBy', 'createdByTeam', 'modifyiedByTeam'
  ];
  ...
  constructor(private dialog: MatDialog,
    ...
    this.titleService.setTitle('Presales copper Request');
  ...
  onCreate() {//this.requestid
    this.router.navigate(['/copperRequestForm']);
  }

  onEdit(r: any) {

    this.router.navigate(['/copperRequestForm'], { queryParams: { id: r.id } });
